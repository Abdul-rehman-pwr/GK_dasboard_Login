    ...
    '& .react-datepicker': {
      ...
      '& > .react-datepicker__navigation': {
        ...
        '&.react-datepicker__navigation--previous': {
          ...
          ...(theme.direction === 'ltr'
            ? {
                backgroundImage: `${"url(\"data:image/svg+xml,%3Csvg width='30' height='30' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill='currentColor' d='M16.0775 10.2441L11.3217 15L16.0775 19.7558L17.2558 18.5775L13.6783 15L17.2558 11.4225L16.0775 10.2441Z' /%3E%3C/svg%3E\")".replace('currentColor', theme.palette.mode === 'dark' ? 'rgb(230 230 241 / 0.7)' : 'rgb(34 48 62 / 0.7)')}`
              }
            : {
                backgroundImage: `${"url(\"data:image/svg+xml,%3Csvg width='30' height='30' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill='currentColor' d='M13.9225 19.7558L18.6783 15L13.9225 10.2441L12.7441 11.4225L16.3216 15L12.7441 18.5775L13.9225 19.7558Z' /%3E%3C/svg%3E\")".replace('currentColor', theme.palette.mode === 'dark' ? 'rgb(230 230 241 / 0.7)' : 'rgb(34 48 62 / 0.7)')}`
              }),
...
const AppReactDatepicker = props => {
  ...
  return (
    <StyledReactDatePicker {...boxProps}>
      {props?.label && <label style={{ fontSize: '0.875rem', marginBottom: '4px' }}>{props?.label}</label>}
