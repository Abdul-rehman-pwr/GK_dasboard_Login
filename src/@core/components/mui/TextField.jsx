...
const TextFieldStyled = styled(TextField)(({ theme, styles }) => ({
  '& .MuiInputLabel-root': {
    transform: 'none',
    width: 'fit-content',
    maxWidth: '100%',
  ...
  '& .MuiInputBase-input': {
    color: styles?.layout == 'Basic' ? 'default' : styles?.themeColor == 'default' ? 'default' : styles?.themeColor,
  ...
  '& .MuiSelect-select.MuiInputBase-inputSizeSmall, & .MuiNativeSelect-select.MuiInputBase-inputSizeSmall': {
    '& ~ i, & ~ svg': {
      ...
      blockSize: '1.125rem',
      color:
        styles?.layout == 'Basic' || styles?.layout == 'Rounded'
          ? 'default'
          : styles?.layout == 'Straight' || styles?.layout == 'Circle'
            ? styles?.themeColor
            : styles?.themeColor == 'default'
              ? 'default'
              : styles?.color
    }
  },
...
const CustomTextField = forwardRef((props, ref) => {
  const { size = 'small', InputLabelProps, styles, ...rest } = props
  return (
    <TextFieldStyled
      size={size}
      styles={styles}
